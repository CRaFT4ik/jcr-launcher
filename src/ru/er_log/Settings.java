...
public class Settings {
    ...
    public static final String[] version			= { "v6.2.1" }; // Версия программы (не используйте символ пробела)
    ...
    //public static final String[] off_user			= { "Player" }; 	// Имя пользователя одиночной игры (если пользователь не ввел ник)
