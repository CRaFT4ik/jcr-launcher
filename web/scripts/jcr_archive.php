<?php
	...
	$archive_path = "../files/client.zip"; // Размещение файл архива
	$src_path = "../files/client/"; // Путь архивации
	
	/**
	 * !!! Процесс архивации не проработан. !!!
	 */
	...
	if(!file_exists($archive_path))
	{
		...
		{
		    echo 'Архив был успешно создан. Вы можете <a href="'.$archive_path.'">скачать</a> его.';
		}
	} else
	{
